...
#player
player_image = pygame.image.load('project_game/assets/player_static.png').convert_alpha()# convert_alpha creates a new copy of the surface with the desired pixel format
...
#fonts
font = pygame.font.Font('project_game/assets/pixeloidMono.ttf', TILESIZE//2)

#sound effects
pickup = pygame.mixer.Sound('project_game/assets/powerup.mp3')
